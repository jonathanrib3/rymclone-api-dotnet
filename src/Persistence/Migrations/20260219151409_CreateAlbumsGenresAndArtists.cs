    ...
    public partial class CreateAlbumsGenresAndArtists : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_albums_genres", x => new { x.album_id, x.genre_id });
                    table.ForeignKey(
                        name: "FK_albums_genres_albums_album_id",
                        column: x => x.album_id,
                        principalTable: "albums",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_albums_genres_genres_genre_id",
                        column: x => x.genre_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_albums_genres_genre_id",
                table: "albums_genres",
                column: "genre_id");
        }
